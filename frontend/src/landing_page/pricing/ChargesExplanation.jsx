...
function ChargesExplanation() {
    return ( 
        <div className="container" style={{color:'#424242', marginBottom:"90px", paddingTop:"80px"}}>
            <div className="row">
                <h2 style={{fontSize:"25px", marginBottom:"30px"}}>Charges explained</h2>
                <div className="col">
                    ...
                    <ul style={{fontSize:"13px", paddingLeft:"22px"}}>
                ...
                <div className="col">
                    ...
                    <ul style={{fontSize:"13px", paddingLeft:"22px"}}>
                        <li className='mb-2'><b style={{fontWeight:"500"}}>Delivery & MTF Brokerage:</b> 0.5% per executed order.</li>
                        <li className='mb-2'><b style={{fontWeight:"500"}}>Intraday Brokerage:</b> 0.05% per executed order.</li>
                    </ul>
                </div>
                <p style={{fontSize:"17px", marginTop:"17px"}}>Disclaimer</p>
